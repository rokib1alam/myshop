       ...
       <div class="container">
            <div class="row">
               <div class="col-md-6 col-12 text-center text-md-start">
                     <div class="top_bar_icon d-inline-block me-3">
                        <img src="{{ asset('/') }}frontend/assets/images/ecom/phone.png" alt=""> +88 01719031163
                     </div>
                     <div class="top_bar_icon d-inline-block">
                        <img src="{{ asset('/') }}frontend/assets/images/ecom/mail.png" alt="">
                        <a href="mailto:fastsales@gmail.com" class="text-reset">rokibul1alam@gmail.com</a>
                     </div>
               </div>
                    <div class="col-6 text-end d-none d-md-block">
                        <div class="dropdown selectBox d-inline-block me-3">
                                    ...
                                    <a class="dropdown-item" href="javascript:void(0)">
                                        <span class="me-2">
                                            <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <circle cx="8" cy="6" r="4" fill="#F42A41" />
                                            </svg>
                                        </span>
                                        Bangladesh
                        ...
                        {{-- <div class="dropdown d-inline-block">
                            <a class="dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                Currency<i class="fas fa-chevron-down ms-1"></i>
                            </a>
                            <ul class="dropdown-menu">
                        ...
                        <div class="dropdown selectBox d-inline-block">
                            <a class="dropdown-toggle selectValue text-reset" href="javascript:void(0)" data-bs-toggle="dropdown" aria-expanded="false">
                                Currency<i class="fas fa-chevron-down ms-1"></i>
                            </a>
                            <ul class="dropdown-menu">
          ...
          <div class="row w-100 align-items-center gx-lg-2 gx-0">
             <div class="col-xxl-2 col-lg-3 col-md-6 col-5">
                <a class="navbar-brand d-none d-lg-block" href="index.html">
                   <img src="{{ url($setting->logo) }}" alt="img" style="max-width: 150px; max-height: 50px;" />
                </a>
                <div class="d-flex justify-content-between w-100 d-lg-none">
                   <a class="navbar-brand" href="index.html">
                      <img src="{{ url($setting->logo) }}" alt="img" style="max-width: 110px; max-height: 40px;"/>
                   </a>
                </div>
             </div>
       ...
       <div class="container">
          <div class="offcanvas offcanvas-start" tabindex="-1" id="navbar-default" aria-labelledby="navbar-defaultLabel">
             <div class="offcanvas-header pb-1">
                <a href="index.html"><img src="{{ url($setting->logo) }}" alt="img" style="max-width: 110px; max-height: 40px;" /></a>
                  ...
                  <div class="collapse mt-2" id="collapseExample">
                     <div class="card card-body">
                        <ul class="mb-0 list-unstyled">
                              <!-- Nested Dropdown Menu Here -->
                              @foreach ($categories as $category)
                                 <li class="dropdown-submenu">
                                    <a class="dropdown-item dropdown-toggle" href="#" role="button" aria-haspopup="true" aria-expanded="false">{{ $category->category_name }}</a>
                                    <ul class="dropdown-menu">
                                          @foreach ($category->subcategories as $subcategory)
                                             <li class="dropdown-submenu">
                                                <a class="dropdown-item dropdown-toggle" href="#" role="button" aria-haspopup="true" aria-expanded="false">{{ $subcategory->subcategory_name }}</a>
                                                <ul class="dropdown-menu">
                                                      @foreach ($subcategory->childCategories as $childCategory)
                                                         <li><a class="dropdown-item" href="#">{{ $childCategory->childcategory_name }}</a></li>
                                                      @endforeach
                                                </ul>
                                             </li>
                                          @endforeach
